                        ...
                        foreach ($result as $row) {
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="editUser.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                                <button type="button" value="<?php echo $row['id']; ?>" class="btn btn-danger btn-sm deleteuserbtn">Delete</button>
                              </td>
                            </tr>
                          <?php
                        }
